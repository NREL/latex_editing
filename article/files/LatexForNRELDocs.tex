...
\subsection{NREL class files}\label{sec:nrelcls}
...
\begin{description}
\item[NRELreport]{compiles the document using the LaTeX \emph{report} class, with NREL formatting. This is intended for longer documents and allows the use of chapters.}
